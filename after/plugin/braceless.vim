...
augroup after_plugin_braceless
  ...
  autocmd FileType python nnoremap <buffer> <silent> ,bld :%g/\<def\>/norm zc<cr>
  " BraceLess Classes - create folds for the classes
  autocmd FileType python nnoremap <buffer> <silent> ,blc :%g/\<class\>/norm zc<cr>
  " BraceLess All - switch to the slow fold method to create them all
  autocmd FileType python nnoremap <buffer> <silent> ,bla :BracelessEnable +fold-slow<cr>
